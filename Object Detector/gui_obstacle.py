...
def obstacle_avoid(imgL):
    ...
    if np.sum(mask) / 255.0 > 0.01 * mask.shape[0] * mask.shape[1]:
        ...
        if cv2.contourArea(cnts[0]) > 0.01 * mask.shape[0] * mask.shape[1]:
            ...
            cv2.putText(imgL, "WARNING !", (x + 5, y - 40), 1, 2, (0, 0, 255), 2, 2)
            cv2.putText(imgL, "Object at", (x + 5, y), 1, 2, (100, 10, 25), 2, 2)
            cv2.putText(imgL, "%.2f cm" % depth_mean, (x + 5, y + 40), 1, 2, (100, 10, 25), 2, 2)
    else:
        cv2.putText(imgL, "SAFE!", (100, 100), 1, 3, (0, 255, 0), 2, 3)
